...
namespace StorageMaster.Core
{
    public class StorageMaster
    {
        ...
        public string LoadVehicle(IEnumerable<string> productNames)
        {
            ...
            string result = $"Loaded {counter}/{productNames.Count()} poroducts into {this.currentVehicle.GetType().Name}";
            return result;
        }
        ...
        public string UnloadVehicle(string storageName, int garageSlot)
        {
            ...
            string result = $"Unloaded {unloadedProductsCount}/{countProductsInVehicle} products at {storageName}";
            return result;
        }
        ...
        public string GetStorageStatus(string storageName)
        {
            ...
            foreach (Product product in storage.Products)
            {
                ...
                if (!productAndCount.ContainsKey(productTypeName))
                {
                    productAndCount.Add(productTypeName, 1);
                }
                else
                {
                    productAndCount[productTypeName]++;
                }
            }
            ...
            //Dictionary<string, int> sortedProducts = productAndCount
            ...
            string[] productsAsStrings = productAndCount
                .OrderByDescending(p => p.Value)
                .ThenBy(p => p.Key)
